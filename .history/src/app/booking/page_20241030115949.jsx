                ...
                <div className='space-y-2'>
                    ...
                    <div className='flex space-x-4'>
                        <input
                            ...
                            className='w-full appearance-none h-2 bg-orange-100 rounded-lg cursor-pointer accent-yellow-500'
                        />
                        <input
                            type='range'
                            min='0'
                            ...
                            className='w-full appearance-none h-2 bg-yellow-100 rounded-lg cursor-pointer accent-yellow-500'
                        />
                    </div>
                </div>
