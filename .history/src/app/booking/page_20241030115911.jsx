                ...
                <div className='space-y-2'>
                    ...
                    <div className='flex space-x-4'>
                        <input
                            ...
                            className='w-full appearance-none h-2 bg-white rounded-lg cursor-pointer accent-yellow-400'
                        />
                        <input
                            type='range'
                            min='0'
                            ...
                            className='w-full appearance-none h-2 bg-yellow-400 rounded-lg cursor-pointer accent-yellow-400'
                        />
                    </div>
                </div>
