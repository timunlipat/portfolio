                ...
                <div className='space-y-2'>
                    ...
                    <div className='flex space-x-4'>
                        <input
                            ...
                            className='w-full appearance-none h-2 bg-yellow-300 rounded-lg cursor-pointer accent-black'
                        />
                        <input
                            type='range'
                            min='0'
                            ...
                            className='w-full appearance-none h-2 bg-yellow-300 rounded-lg cursor-pointer accent-yellow-600'
                        />
                    </div>
                </div>
