...
const BookingForm = () => {
    ...
    const categories = {
        ...
        places: {
            ...
            fields: [
                {
                    icon: Star, // Substitute for Tree icon
                    label: 'Type',
                    options: ['Any', 'Beach', 'Mountain', 'City', 'Resort'],
                },
                {
                    icon: Calendar, // Substitute for CalendarCheck icon
                    label: 'Availability',
                    options: [
                        'Any',
                        'Weekend Only',
                ...
                {
                    icon: Camera, // Substitute for Camera icon
        ...
        stadiums: {
            ...
            fields: [
                {
                    icon: Trophy, // Substitute for Sports icon
                    label: 'Event Type',
                    options: ['Any', 'Sports', 'Concert', 'Exhibition'],
                },
                {
                    icon: Chair, // Substitute for Chair icon
                    label: 'Seating',
        ...
        cars: {
            ...
            fields: [
                ...
                {
                    icon: Gauge, // Substitute for Gear icon
                    label: 'Transmission',
                    options: ['Automatic', 'Manual', 'Semi-Auto'],
                },
                {
                    icon: Star, // Substitute for ColorPalette icon
                    label: 'Color Options',
